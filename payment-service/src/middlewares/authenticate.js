...
// Yêu cầu request gắn Bearer Token — Payment Service giải mã và gắn user vào req.
// Token có thể do Auth Service phát hành (khách tự thao tác) hoặc do Order Service tự ký
// bằng token hệ thống khi cần tra cứu nội bộ — Payment Service chỉ verify chữ ký dùng chung,
// không phân biệt nguồn gốc (cùng triết lý với Warehouse Service).
